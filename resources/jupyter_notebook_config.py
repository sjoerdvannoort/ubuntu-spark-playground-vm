...
# the root folder for notebooks
c.ContentsManager.root_dir = "/opt/sparkplayground/notebooks"

## Whether to allow the user to run the server as root. Default: False
...
#  Default: {}
#c.ServerApp.jpserver_extensions = {"sparksql_magic": True}
